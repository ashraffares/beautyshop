...
class TitlesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create title" do
    assert_difference('Title.count') do
      post titles_url, params: { title: { born: @title.born, content: @title.content, date: @title.date, img: @title.img, pors: @title.pors } }
    end
  ...
  test "should update title" do
    patch title_url(@title), params: { title: { born: @title.born, content: @title.content, date: @title.date, img: @title.img, pors: @title.pors } }
